...
def print_tuple(tuple): #def is saying 'function'
  for item in tuple: # go through all items in a tuple
    print(item) # then print those items
...
#to write a tuple containing a single value you must include a comma otherwise it evaluates to a 1 integer
print_tuple(u)
